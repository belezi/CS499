...
<body>
    ...
    <table id="forecast" cellspacing="0">
    ...
    <table id="controls" cellspacing="0">
        <tr id="controlsTitles">
        </tr>
        <tr id="controlsOptions">
        </tr>
        <tr id="">
            <td></td>
            <td></td>
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDVIzeS772dV305xcQ3MwBAMpzgGvYCcT0"></script>
